const page_config = {
    'title': 'office 365 account creation',
    'line1': 'office 365',
    'line2': '(Onedrive + Office)',
    'line3': ''
}
...
<body>
    <a href="https://github.com/nabeelshaikh7/didactic-winner"><img width="149" height="149" src="https://github.blog/wp-content/uploads/2008/12/forkme_right_darkblue_121621.png?resize=149%2C149" class="attachment-full size-full" alt="Fork me on GitHub" data-recalc-dims="1" style="position: absolute; top: 0;z-index: 999999;right: 0"></a>
    <div id="fullpage">
        <div class="section intro">
            ...
            <div class="mdui-text-color-white-text" align="center" style="width: 70%;margin: auto">
                ...
                <br><br><br><br>
                <a href="#form"><button class="mdui-btn mdui-ripple mdui-color-red mdui-m-a-2" style="width: 140px;height: 50px">Get it now</button></a>
                <a href="https://www.office.com/login"><button class="mdui-m-a-2 mdui-btn mdui-ripple mdui-color-white" style="width: 140px;height: 50px">log in</button></a>
            </div>
        </div>
        <div class="section form">
            ...
            <div class="mdui-container">
                <div class="mdui-row">
                    <h2 style="font-size: 40px;font-weight: 500" id="aform">office 365 account creation</h2>
                    <form id="aform">
                        <div class="mdui-textfield mdui-textfield-floating-label">
                            ...
                            <div class="mdui-textfield-error">english</div>
                        </div>
                        <div class="mdui-textfield mdui-textfield-floating-label">
                        ...
                        <div class="mdui-textfield mdui-textfield-floating-label">
                            <label class="mdui-textfield-label">Mailbox prefix *</label>
                            <input class="mdui-textfield-input" type="text" name="username" pattern="[A-z0-9]{1,50}" required>
                            <div class="mdui-textfield-error">@ The first character, letters/numbers are allowed</div>
                        </div>
                        <br><br>
                        ...
                        <div style="margin-top: 20px; color: gray">* Account information will be displayed on the webpage after submission, please do not refresh</div>
                    </form>
                    <div class="ainfo" style="display: none">
                        <h2 style="font-size: 30px;font-weight: 500"> The account is successfully created!</h2>
                        <label class="mdui-textfield-label">mailbox</label>
                        <input class="mdui-textfield-input cremail" type="text" value="">
                        <label class="mdui-textfield-label">Initial password</label>
    ...
    <script>
        $('form').submit(function(e) {
            ...
            mdui.dialog({
                ...
                content: 'Click to confirm and start to create an account, please wait patiently and do not refresh the web page',
                buttons: [{
                    text: 'cancel'
                }, {
                    text: 'confirm',
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                if (response.stat == 'success') {
                                    ...
                                    mdui.alert('Creation failed, prefix is already occupied');
                                } else if (response.stat == 'wrong recaptcha') {
                                    mdui.alert(' authentication error');
                                } else {
